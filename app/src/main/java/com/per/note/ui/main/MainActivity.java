...
import com.per.note.ui.chart.PieChartFragment;
import com.per.note.utils.LogUtils;


public class MainActivity extends FragmentActivity {
    private Fragment mMainFragment, mCountFragment, currentFragment, mMoreFragment,mChartFragment;
    private long lastPressTime;
    private RadioButton mRbMain, mRbCount, mRbMore,mRbChart;
    ...
    private void initView() {
        ...
        mRbChart = (RadioButton) findViewById(R.id.main_rb_chart);
    ...
    private void setListener() {
        ...
        mRbChart.setOnClickListener(mListener);
    }
        ...
        public void onClick(View v) {
            ...
            switch (v.getId()) {
                ...
                case R.id.main_rb_more:
                    ...
                    break;
                case R.id.main_rb_chart:
                     addOrShowFragment(mChartFragment);
                    break;
                default:
                    break;
            }
    ...
    private void addOrShowFragment(Fragment fragment) {
        ...
        //判断当前Fragment是否是mChartFragment，如果不是移除mChartFragment，便于mChartFragment重绘
        if(!currentFragment.equals(mChartFragment)){
            Log.i("------","remove");
